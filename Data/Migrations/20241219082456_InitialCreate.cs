        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GroupDetailsId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Conversations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Conversations_GroupDetails_GroupDetailsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Conversations_GroupDetailsId",
                table: "Conversations",
                column: "GroupDetailsId",
                unique: true,
                filter: "[GroupDetailsId] IS NOT NULL");
